...
public class DBProperties {
    ...
    public static String dbDatamartHost;
    public static String dbDatamartPort;
    public static String dbDatamartUsername;
    public static String dbDatamartPassword;
    public static String dbDatamart;
    ...
    private static void loadProperties(File file) throws IOException {
        ...
        dbDatamartHost = properties.getProperty("db_datamart.host");
        dbDatamartPort = properties.getProperty("db_datamart.port");
        dbDatamartUsername = properties.getProperty("db_datamart.username");
        dbDatamartPassword = properties.getProperty("db_datamart.password");
        dbDatamart = properties.getProperty("db_datamart.name");
